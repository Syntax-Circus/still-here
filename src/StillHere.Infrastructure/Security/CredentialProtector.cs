...
/// database-column encryption library. See docs/architecture/04-DECISION-LOG.md Decision 4.
/// </summary>
internal sealed class CredentialProtector : ICredentialProtector
{
    private const string Purpose = "StillHere.DnsProviderCredentials";
